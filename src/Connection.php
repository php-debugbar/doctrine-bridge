...
class Connection extends AbstractConnectionMiddleware
{
    ...
    {
        $this->debugStack->addQuery(fn () => parent::beginTransaction(), 'START TRANSACTION', null, 'transaction');
    }

    public function commit(): void
    {
        $this->debugStack->addQuery(fn () => parent::commit(), 'COMMIT', null, 'transaction');
    }
